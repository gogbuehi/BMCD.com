...
{
	public class BMCDModelList
	{
		public function BMCDModelList()
		{
			if(BMCDModelList._instance){
				throw new Error("Only one instance of this class may exist. Use BMCDCategoryList.getInstance()");
			}
		}
		private static var _instance:BMCDModelList;
		public static function getInstance():BMCDModelList{
			if(!_instance){
				_instance = new BMCDModelList();
			}
			return _instance;
		}
