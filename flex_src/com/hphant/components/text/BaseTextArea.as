 ...
 *
 */
public class BaseTextArea extends ScrollControlBase
...
//      textField.background = false;
    ...
    mx_internal function createTextField(childIndex:int):void
    {
        if (!textField)
        {
            textField = IUITextField(createInFontContext(BaseUITextField));
                                      ...
                                      dispatchValueCommitEvent:Boolean):void
    {
		...
		var xmlProperties:Object = XML.settings();
