...
require_once 'includes/amfphp/services/vo/Master.php';


/**
 * Description of Content_Library_Master
 *
 * @author Goodwin
 */
class Content_Library_Master extends DBObject {
	public $d_location;
    ...
    function loadDataFromAmfPhp(Master $master) {
        $transientData = $master->getFields();
    ...
    function getAmfPhpInstance() {
        ...
        $master->thumbnailLocation = $this->d_o_content_library_thumbnail->d_location;
        return $master;
    }
