...
define('LOG_DIRECTORY',"f:\\web\\bmcd\\logs");
define('LOG_BASE_FILENAME','php.log');
define('LOG_LEVEL',0);
define('LOG_ALERT_EMAIL','dont-send-email@bmcd.loc');

define('FTP_DIRECTORY',"f:\\web\bmcd\\ftp");
define('CONTENT_DIRECTORY',"f:\\web\\bmcd\\content");
...
//HOST CONSTANTS
define('HOSTNAME','bmcd.loc');
define('CONTENT','content.bmcd.loc');
define('SUBDOMAIN_999','999.bmcd.loc');
define('SUBDOMAIN_901','901.bmcd.loc');
...
define('WEB_901_INCLUDE_PATH',"F:/web/bmcd/web;.;F:/web/bmcd/901;F:/web/bmcd/secure;F:/web/bmcd/content/cache");
define('WEB_999_INCLUDE_PATH',"F:/web/bmcd/web;.;F:/web/bmcd/999;F:/web/bmcd/secure;F:/web/bmcd/content/cache");
