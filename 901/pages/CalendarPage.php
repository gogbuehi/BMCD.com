<?php
    ...
    class CalendarPage extends Bmcd901Page {
    	const IDENTIFIER='_901_calendar_';
		protected $calendar;
		...
		function makeContent() {
            ...
            if ($recordCount == 1) {
                ...
                $this->tLog->debug("Title has been set to: ".$this->filterElements['title']);
            }

            $this->tLog->debug('Record count is: '.$recordCount);
		...
		function getFilterElements() {
            ...
            return "$aTitle | British Motor Car Distributors Special Event | Land Rover, Jaguar | $aCity$aState";
        }
