<?php
    ...
    class ServiceRequestPage extends Bmcd901Page {
		...
		function makeContent() {
			$floor = $this->makeFloor(); //Todo: This should be "createFloor"
				...
				$module->addBodyText('To schedule a service appointment, please fill out the form below. Please call us (415) 776-7700, if you would like to schedule an appointment within the next two days.');
