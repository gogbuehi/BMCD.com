<?php
    ...
    class ModelLineupPage extends Bmcd901Page {
    	const IDENTIFIER='_901_model_lineup_';
		...
		function getFilterElements() {
            ...
            return "$aModel $aSubmodel, $aMake | Model Info | British Motor Car Distributors";
        }
