<?php
    ...
    class QuickQuote extends Bmcd901Page {
    	function __construct($url=null) {
    		parent::__construct('Quick Quote',$url);
			$this->makeContent();
    	}
		function makeContent() {
			$floor = $this->makeFloor(); //Todo: This should be "createFloor"
				...
				$module->addBodyText('If you are interested in a particular vehicle and would like to be contacted by a sales representative please fill out the form below and we\'ll contact you with a quote as soon as possible.');
				$module->addTitleText('Quick Quotes');
				...
				$module->addMore($this->createLineItem('/forms/quick_quote','Quick Quote','selected'));
